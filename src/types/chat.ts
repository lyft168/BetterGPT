...
export type ModelOptions = 'gpt-3.5-turbo' | 'gpt-3.5-turbo-0613' |  'gpt-3.5-turbo-16k' | 'gpt-3.5-turbo-16k-0613' | 'gpt-4' | 'gpt-4-0314' | 'gpt-4-0613' | 'gpt-4-32k' | 'you-chat' | 'vicuna-7b-test' | 'oasst-sft-6-llama-30b' | 'oasst-sft-4-pythia-12b' | 'oasst-sft-1-pythia-12b' | 'oasst-llama-2-30b' | 'oasst-llama-2-70b' | 'llama-2-7b' | 'llama-2-70b' | 'llama-2-13b' | 'claude-instant' | 'claude-2' | 'claude-100k' |  'claude-2-100k' | 'bing' | 'palm-2' | 'falcon-180b' |  'mythomax-13b' | 'airochronos-33b' |  'guanaco-33b' | 'xwin-70b';
